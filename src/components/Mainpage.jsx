            ...
            <div className='stackplace'>
                ...
                <div className="achivements">
                    ...
                    <div className="achievementsbox">
                        <ul className='achul'>
                            <li style={{marginBottom:"30px", marginTop:"20px"}}><h6>Recognized by EPAM Center of Excellence – EPAM.  <a href="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/epam+certification.pdf"><img className='link' src="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/link.png" alt="link" style={{height:"18px",width:"18px"}}/></a></h6></li>
                            <li style={{marginBottom:"30px"}}><h6>Completed AWS Academy Cloud Foundations Certification, AWS. <a href="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/AWS_Academy_Graduate___AWS_Academy_Cloud_Foundations_Badge20220416-46-1s4br40.pdf"><img className='link' src="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/link.png" alt="link" style={{height:"18px",width:"18px"}}/></a></h6></li>
                            <li style={{marginBottom:"30px"}}><h6>Achieved Problem Solving (Intermediate) Certification – HackerRank. <a href="https://www.hackerrank.com/certificates/4651a24375b3"><img className='link' src="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/link.png" alt="link" style={{height:"18px",width:"18px"}}/></a></h6></li>
                            <li style={{marginBottom:"30px"}}><h6>Earned Python (Basic) Certification – HackerRank. <a href="https://www.hackerrank.com/certificates/c4a1658f633b"><img className='link' src="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/link.png" alt="link" style={{height:"18px",width:"18px"}}/></a></h6></li>
                            <li style={{marginBottom:"30px"}}><h6>Attained Java Developer Certification – Excelr Edutech Solutions. <a href="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/excelr+course+completion+certificate.pdf"><img className='link' src="https://portfolio-hemanth.s3.ap-south-1.amazonaws.com/link.png" alt="link" style={{height:"18px",width:"18px"}}/></a></h6></li>
                        </ul>
                    </div>
                </div>
            </div>
